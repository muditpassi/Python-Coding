...
# 7 x 3600 seconds or 25200 seconds.
# Similarly, in the second query, time difference is 5 hours and 30 minutes for time zone adjusting for that we have a
# difference of 1 day and 30 minutes. Or 24 x 3600 + 30 x 60 = 88200

from datetime import datetime as dt

def time_delta(t1, t2):
    formt = "%a %d %b %Y %H:%M:%S %z"
    print(int(abs((dt.strptime(t1, formt) - dt.strptime(t2, formt)).total_seconds())))
